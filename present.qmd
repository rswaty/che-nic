...
```{r evt chart, fig.height=8, fig.width=14, out.width="100%", message=FALSE, warning=FALSE}
#| echo: false
...
```{r evc chart, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=8, out.width="100%"}
...
```{r evh chart, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=8, out.width="100%"}
